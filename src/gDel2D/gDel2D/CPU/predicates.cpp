...
/* h cannot be e or f. */
int fast_expansion_sum_zeroelim(int elen, RealType *e, int flen, RealType *f,
                                RealType *h) {
  RealType Q;
...
int scale_expansion_zeroelim(int elen, RealType *e, RealType b, RealType *h) {
...
RealType estimate(int elen, RealType *e) {
  RealType Q;
  int eindex;
...
RealType orient2dadapt(const RealType *pa, const RealType *pb,
                       const RealType *pc, const RealType detsum) {
...
RealType orient2d(const RealType *pa, const RealType *pb, const RealType *pc) {
...
RealType incirclefast(const RealType *pa, const RealType *pb,
...
RealType incircleexact(const RealType *pa, const RealType *pb,
                       const RealType *pc, const RealType *pd) {
...
RealType incircleadapt(const RealType *pa, const RealType *pb,
                       const RealType *pc, const RealType *pd,
                       RealType permanent) {
  ...
  RealType axtbct[16], aytbct[16], bxtcat[16], bytcat[16], cxtabt[16],
      cytabt[16];
...
RealType incircle(const RealType *pa, const RealType *pb, const RealType *pc,
                  const RealType *pd) {
