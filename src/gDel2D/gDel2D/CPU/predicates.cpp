...
/* h cannot be e or f. */
int fast_expansion_sum_zeroelim(int elen, RealType *e, int flen, RealType *f, RealType *h)
{
    RealType Q;
...
RealType orient2dadapt(const RealType *pa, const RealType *pb, const RealType *pc, const RealType detsum)
{
...
RealType incirclefast(const RealType *pa, const RealType *pb, const RealType *pc, const RealType *pd)
{
...
RealType incircleexact(const RealType *pa, const RealType *pb, const RealType *pc, const RealType *pd)
{
...
RealType incircleadapt(const RealType *pa,
                       const RealType *pb,
                       const RealType *pc,
                       const RealType *pd,
                       RealType permanent)
...
RealType incircle(const RealType *pa, const RealType *pb, const RealType *pc, const RealType *pd)
{
