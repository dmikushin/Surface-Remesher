...
private:
    ...
    __forceinline__ __device__ Orient doOrient2DFastExact(const RealType *p0,
                                                          const RealType *p1,
                                                          const RealType *p2) const;

    __forceinline__ __device__ Orient
    doOrient2DSoSOnly(const RealType *p0, const RealType *p1, const RealType *p2, int v0, int v1, int v2) const;
    ...
    __forceinline__ __device__ RealType doOrient1DExact_Lifted(const RealType *p0, const RealType *p1) const;
    ...
    __forceinline__ __device__ Side doInCircleSoSOnly(const RealType *p0,
                                                      const RealType *p1,
                                                      const RealType *p2,
                                                      const RealType *p3,
                                                      int v0,
