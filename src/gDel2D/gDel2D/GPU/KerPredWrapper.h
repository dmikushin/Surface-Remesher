...
__forceinline__ __device__ Orient DPredWrapper::doOrient2DFastExact(const RealType *p0,
                                                                    const RealType *p1,
...
__forceinline__ __device__ Orient DPredWrapper::doOrient2DSoSOnly(const RealType *p0,
                                                                  const RealType *p1,
                                                                  const RealType *p2,
                                                                  int v0,
                                                                  int v1,
...
__forceinline__ __device__ Side DPredWrapper::doInCircleFastExact(const RealType *p0,
                                                                  const RealType *p1,
                                                                  const RealType *p2,
...
__forceinline__ __device__ RealType DPredWrapper::doOrient1DExact_Lifted(const RealType *p0, const RealType *p1) const
{
    const RealType det = orient1dExact_Lifted(_predConsts, p0, p1);
    return det;
}

__forceinline__ __device__ RealType DPredWrapper::doOrient2DExact_Lifted(const RealType *p0,
                                                                         const RealType *p1,
                                                                         const RealType *p2,
                                                                         bool lifted) const
{
...
__forceinline__ __device__ Side DPredWrapper::doInCircleSoSOnly(const RealType *p0,
                                                                const RealType *p1,
                                                                const RealType *p2,
                                                                const RealType *p3,
                                                                int v0,
