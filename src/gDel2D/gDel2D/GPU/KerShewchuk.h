...
__device__ int d_scale_expansion_zeroelim(const RealType *predConsts, int elen, RealType *e, RealType b, RealType *h)
{
    RealType Q, sum;
    RealType hh;
    RealType product1;
...
/* h cannot be e or f. */
__device__ int d_fast_expansion_sum_zeroelim(int elen, RealType *e, int flen, RealType *f, RealType *h)
{
    RealType Q;
    RealType Qnew;
    RealType hh;
...
__device__ RealType d_fast_expansion_sum_sign(int elen, RealType *e, int flen, RealType *f)
{
    RealType Q;
    RealType lastTerm;
    RealType Qnew;
...
__device__ RealType orient2dFast(const RealType *predConsts, const RealType *pa, const RealType *pb, const RealType *pc)
{
...
__device__ RealType orient2dDet(const RealType *predConsts, const RealType *pa, const RealType *pb, const RealType *pc)
{
...
__noinline__ __device__ int calc_det(const RealType *predConsts,
                                     RealType *a,
                                     RealType *b,
                                     RealType *c,
                                     RealType fx0,
...
__forceinline__ __device__ RealType incircleFastAdaptExact(const RealType *predConsts,
                                                           const RealType *pa,
                                                           const RealType *pb,
                                                           const RealType *pc,
                                                           const RealType *pd)
...
__forceinline__ __device__ RealType
incircleFast(const RealType *predConsts, const RealType *pa, const RealType *pb, const RealType *pc, const RealType *pd)
{
    RealType adx, bdx, cdx, ady, bdy, cdy;
    RealType bdxcdy, cdxbdy, cdxady, adxcdy, adxbdy, bdxady;
    RealType alift, blift, clift;
...
__forceinline__ __device__ RealType
incircleDet(const RealType *predConsts, const RealType *pa, const RealType *pb, const RealType *pc, const RealType *pd)
{
    RealType adx, bdx, cdx, ady, bdy, cdy;
    RealType bdxcdy, cdxbdy, cdxady, adxcdy, adxbdy, bdxady;
    RealType alift, blift, clift;
...
__device__ RealType orient1dExact_Lifted(const RealType *predConsts, const RealType *pa, const RealType *pb)
{
