...
__global__ void kerUpdateVertIdx(KerTriArray triVec, char *triInfoArr, int *orgPointIdx);
...
__global__ void kerCollectFreeSlots(char *triInfoArr, int *prefixArr, int *freeArr, int newTetNum);
__global__ void kerMakeCompactMap(KerCharArray triInfoVec, int *prefixArr, int *freeArr, int newTriNum);
__global__ void kerCompactTris(KerCharArray triInfoVec, int *prefixArr, Tri *triArr, TriOpp *oppArr, int newTriNum);
